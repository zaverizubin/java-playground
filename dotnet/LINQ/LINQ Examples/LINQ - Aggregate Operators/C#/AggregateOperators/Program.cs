    ...
    class Program
    {
        ...
        class LinqSamples
        {
            ...
            public void Linq76()
            {
                ...
                orderCounts = customers.Select(c => new { c.CustomerID, OrderCount = c.Orders.Count() });
            ...
            public void Linq77()
            {
                ...
                categoryCounts =
                    products.GroupBy(p => p.Category, (key, prods) => new { Category = key, ProductCount = prods.Count() });
            ...
            public void Linq80()
            {
                ...
                categories = products.GroupBy(p => p.Category, (key, prods) => new
                    {
                        Category = key,
                        TotalUnitsInStock = prods.Sum(p => p.UnitsInStock)
            ...
            public void Linq83()
            {
                ...
                {
                    Category = key,
                    CheapestPrice = prods.Min(p => p.UnitPrice)
            ...
            public void Linq84()
            {
                ...
                {
                    Category = key,
                    CheapestProducts = prods.Where(p => p.UnitPrice == prods.Min(p1 => p1.UnitPrice))

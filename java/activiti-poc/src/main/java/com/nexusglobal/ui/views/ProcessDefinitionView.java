...
public class ProcessDefinitionView extends VerticalLayout {
	...
	private void buildProcessInstanceActionButtons() {
		...
		btnCreateNewProcessInstance.addClickListener(event ->{
			presenter.onButtonClick(ProcessDefinitionActionEnum.New);
		});
		...
		btnCancelAllProcessInstances.addClickListener(event ->{
			presenter.onButtonClick(ProcessDefinitionActionEnum.CancelAll);
		});
	...
	private void buildProcessInstanceFilterButtons() {
		...
		button1.addClickListener(event -> {
			presenter.onButtonClick(ProcessDefinitionActionEnum.Running);
		});
		...
		button2.addClickListener(event -> {
			presenter.onButtonClick(ProcessDefinitionActionEnum.Completed);
		});
		...
		button3.addClickListener(event -> {
			presenter.onButtonClick(ProcessDefinitionActionEnum.All);
		});

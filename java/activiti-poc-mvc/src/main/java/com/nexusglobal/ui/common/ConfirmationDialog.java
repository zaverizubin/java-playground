...
extends Dialog {
	...
	public ConfirmationDialog() {
		...
		final HorizontalLayout buttonBar = new HorizontalLayout(confirmButton,
				cancelButton);
		buttonBar.setClassName("buttons confirm-buttons");

		final Div labels = new Div(messageLabel, extraMessageLabel);
	 ...
	 */
	public void open(final String title, final String message, final String additionalMessage,
			final String actionName, final boolean isDisruptive, final T item, final Consumer<T> confirmHandler,
